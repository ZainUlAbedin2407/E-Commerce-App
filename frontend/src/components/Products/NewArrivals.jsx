...
const NewArrivals = () => {
  ...
  const updateScrollButtons = () => {
    ...
    if (container) {
      ...
      setCanScrollRight(leftScroll < maxScroll - 1);
    }
  };
  ...
  return (
    <section className="py-16 px-4 lg:px-0">
      <div className="container mx-auto text-center mb-10 relative">
        ...
        {/* Scroll buttons */}
        <div className="flex justify-end gap-2 lg:absolute lg:right-0 lg:bottom-[-35px] z-10">
          <button
            onClick={() => scroll("left")}
            disabled={!canScrollLeft}
            className={`border-gray-200 p-2 rounded border transition-colors duration-300 ${
              canScrollLeft
